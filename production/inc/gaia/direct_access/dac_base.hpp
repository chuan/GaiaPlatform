...
protected:
    ...
    static bool insert_into_anchor_chain(common::gaia_id_t anchor_id, common::gaia_id_t id, common::reference_offset_t anchor_slot);
    static bool remove_from_anchor_chain(common::gaia_id_t anchor_id, common::gaia_id_t id, common::reference_offset_t anchor_slot);
};
